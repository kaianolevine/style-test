...
export const author = {
  name: 'Kaiano Levine', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'kaiano.levine@gmail.com', // i.e. hola@lenesaile.com - email of the author
  website: 'https://www.kaianolevine.com', // i.e. https.://www.lenesaile.com - the personal site of the author
...
export const creator = {
  name: 'Kaiano Levine', // i.e. Lene Saile - creator's (developer) name.
